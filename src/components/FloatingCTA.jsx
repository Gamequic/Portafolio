/**
 * FloatingCTA.jsx — Persistent floating action button.
 *
 * Replaces the original ContactMe.jsx Facebook button.
 * Now shows WhatsApp as the primary contact method.
 * Expands on hover to reveal all contact options.
 */
...
const handleContactClick = (label) => {
  if (window.gtag) {
    window.gtag("event", "floating_cta_" + label.toLowerCase(), {
        ...
        {expanded &&
          QUICK_CONTACTS.map((c, i) => (
            <motion.a
              ...
              onClick={() => handleContactClick(c.label)}
